...
def run(n, k, d, rep = 100):
    ...
    filename = "./med_algo_" + n + "_" + str(int(k)) + "_" + str(int(d)) + "_" + str(rep) + "__" + x + ".csv"
    df = pandas.DataFrame(data={"med": medl, "rem": rem, "fgc":fgc, "work": work, "rec": recl, 'case': resl})
